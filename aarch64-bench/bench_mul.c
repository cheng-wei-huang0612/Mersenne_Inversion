...
extern void bignum_mul_p25519(uint64_t z[static 4], const uint64_t x[static 4],const uint64_t y[static 4]);
...
static int bench(void)
{
  ...
  print_median("mul", cycles_ntt);

  printf("\n");

  print_percentile_legend();

  print_percentiles("mul", cycles_ntt);
