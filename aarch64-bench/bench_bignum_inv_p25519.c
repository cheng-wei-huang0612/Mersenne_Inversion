...
{
  uint64_t x[4] = {0x1234567890abcdef, 0xfedcba0987654321, 0x1111222233334444, 0x5555666677778888};
  uint64_t z[4] = {0};
  ...
  print_median("bignum_inv_p25519", cycles_ntt);
  printf("\n");
  print_percentile_legend();
  print_percentiles("bignum_inv_p25519", cycles_ntt);
