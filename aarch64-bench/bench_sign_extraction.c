...
extern void flag_dependent_extraction();
extern void flag_independent_extraction();
...
static int bench_s2n(void)
{
  ...
  print_median("flag_dependent_extraction", cycles_ntt);
  printf("\n");
  print_percentile_legend();
  print_percentiles("flag_dependent_extraction", cycles_ntt);
...
static int bench_my(void)
{
  ...
  qsort(cycles_ntt, NTESTS, sizeof(uint64_t), cmp_uint64_t);
  print_median("flag_independent_extraction", cycles_ntt);
  printf("\n");
  print_percentile_legend();
  print_percentiles("flag_independent_extraction", cycles_ntt);
