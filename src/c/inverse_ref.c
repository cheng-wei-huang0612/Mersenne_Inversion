...
void inverse(uint64_t inv[static 4], uint64_t x[static 4]){
    ...
    update_fg_trunc(&f, &g, uuvvrrss);
        ...
        print_radix30(F, BIGNUM_LIMB);
        printf("\n");
        printf("before update: G = ");
        print_radix30(G, BIGNUM_LIMB);
        printf("\n");
        printf("before update: V = ");
        print_radix30(V, BIGNUM_LIMB);
        printf("\n");
        ...
        mpz_init(mpV);
        mpz_from_30k(mpV, V, BIGNUM_LIMB);
        gmp_printf("before update: mpV = %Zd\n", mpV);
        mpz_clear(mpV);
        }

        printf("before update: S = ");
        print_radix30(S, BIGNUM_LIMB);
        printf("\n");
        printf("before update: uuvvrrss = ");
        printf("uu = %lld, vv = %lld, rr = %lld, ss = %lld\n", 
               uuvvrrss[0], uuvvrrss[1], uuvvrrss[2], uuvvrrss[3]);
        printf("uu0 = %lld, vv0 = %lld, rr0 = %lld, ss0 = %lld\n", 
               uuvvrrss[0] & ((1<<30)-1), uuvvrrss[1] & ((1<<30)-1), uuvvrrss[2] & ((1<<30)-1), uuvvrrss[3] & ((1<<30)-1));
    ...
    update_VS(V, S, uuvvrrss);
        ...
        print_radix30(F, BIGNUM_LIMB);
        printf("\n");
        printf("after  update: G = ");
        print_radix30(G, BIGNUM_LIMB);
        printf("\n");
        printf("after  update: V = ");
        print_radix30(V, BIGNUM_LIMB);
        printf("\n");
        ...
        mpz_init(mpV);
        mpz_from_30k(mpV, V, BIGNUM_LIMB);
        gmp_printf("after  update: mpV = %Zd\n", mpV);
        mpz_clear(mpV);
        }
    ...
    for (size_t loop_count = 0; loop_count < (10-1); loop_count++)
    {
        ...
        print_radix30(F, BIGNUM_LIMB);
        printf("\n");
        printf("[Iteration %zu] before update: G = ", loop_count);
        print_radix30(G, BIGNUM_LIMB);
        printf("\n");
        printf("[Iteration %zu] before update: V = ", loop_count);
        print_radix30(V, BIGNUM_LIMB);
        printf("\n");
        mpz_t mpV;
        mpz_init(mpV);
        mpz_from_30k(mpV, V, BIGNUM_LIMB);
        gmp_printf("[Iteration %zu] before update: mpV = %Zd\n", loop_count, mpV);
        mpz_clear(mpV);
        printf("[Iteration %zu] before update: S = ", loop_count);
        print_radix30(S, BIGNUM_LIMB);
        printf("\n");
        printf("[Iteration %zu] before update: uuvvrrss = ", loop_count);
        printf("uu = %lld, vv = %lld, rr = %lld, ss = %lld\n", 
               uuvvrrss[0], uuvvrrss[1], uuvvrrss[2], uuvvrrss[3]);
        printf("\n");
        ...
        printf("[Iteration %zu] after  update: F = ", loop_count);
        print_radix30(F, BIGNUM_LIMB);
        printf("\n");
        printf("[Iteration %zu] after  update: G = ", loop_count);
        print_radix30(G, BIGNUM_LIMB);
        printf("\n");
        printf("[Iteration %zu] after  update: V = ", loop_count);
        print_radix30(V, BIGNUM_LIMB);
        printf("\n");
        //mpz_t mpV;
        mpz_init(mpV);
        mpz_from_30k(mpV, V, BIGNUM_LIMB);
        gmp_printf("[Iteration %zu] after  update: mpV = %Zd\n", loop_count, mpV);
        mpz_clear(mpV);
        printf("[Iteration %zu] after  update: S = ", loop_count);
        print_radix30(S, BIGNUM_LIMB);
        printf("\n");
        printf("\n");
