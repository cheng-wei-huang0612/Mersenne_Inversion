...
def update_VS_generic(vec_uu0_rr0_vv0_ss0 = vec_uu0_rr0_vv0_ss0, 
    ...
    asm_script += f"smlal {vec_prod}.2d, {vec_l0}.2s, {vec_P0_P1_P2_P3}.s[0]\n"
    ...
    asm_script += f"smlal {vec_prod}.2d, {vec_l0}.2s, {vec_P0_P1_P2_P3}.s[1]\n"
    ...
    asm_script += f"smlal  {vec_prod}.2d, {vec_l1}.2s, {vec_P0_P1_P2_P3}.s[0]\n"
    asm_script += f"sshr   {vec_prod}.2d, {vec_prod}.2d, #30\n"
    ...
    asm_script += f"smlal {vec_prod}.2d, {vec_l0}.2s, {vec_P0_P1_P2_P3}.s[2]\n"
    asm_script += f"smlal {vec_prod}.2d, {vec_l1}.2s, {vec_P0_P1_P2_P3}.s[1]\n"
    ...
    asm_script += f"smlal {vec_prod}.2d, {vec_l0}.2s, {vec_P0_P1_P2_P3}.s[3]\n"
    asm_script += f"smlal {vec_prod}.2d, {vec_l1}.2s, {vec_P0_P1_P2_P3}.s[2]\n"
    ...
    asm_script += f"smlal {vec_prod}.2d, {vec_l0}.2s, {vec_P4_P5_P6_P7}.s[0]\n"
    asm_script += f"smlal {vec_prod}.2d, {vec_l1}.2s, {vec_P0_P1_P2_P3}.s[3]\n"
    ...
    asm_script += f"smlal {vec_prod}.2d, {vec_l0}.2s, {vec_P4_P5_P6_P7}.s[1]\n"
    asm_script += f"smlal {vec_prod}.2d, {vec_l1}.2s, {vec_P4_P5_P6_P7}.s[0]\n"
    ...
    asm_script += f"smlal {vec_prod}.2d, {vec_l0}.2s, {vec_P4_P5_P6_P7}.s[2]\n"
    asm_script += f"smlal {vec_prod}.2d, {vec_l1}.2s, {vec_P4_P5_P6_P7}.s[1]\n"
    ...
    asm_script += f"smlal {vec_prod}.2d, {vec_l0}.2s, {vec_P4_P5_P6_P7}.s[3]\n"
    asm_script += f"smlal {vec_prod}.2d, {vec_l1}.2s, {vec_P4_P5_P6_P7}.s[2]\n"
    ...
    asm_script += f"smlal {vec_prod}.2d, {vec_l0}.2s, {vec_P8_0_0_0}.s[0]\n"
    asm_script += f"smlal {vec_prod}.2d, {vec_l1}.2s, {vec_P4_P5_P6_P7}.s[3]\n"


    asm_script += f"and    {vec_buffer}.16b, {vec_prod}.16b, {vec_2x_2p30m1}.16b\n"
    asm_script += f"sshr   {vec_V8_V9_S8_S9}.2d, {vec_prod}.2d, #30\n"
    asm_script += f"smlal {vec_V8_V9_S8_S9}.2d, {vec_l1}.2s, {vec_P8_0_0_0}.s[0]\n"
...
asm_main += update_VS_generic(vec_uu0_rr0_vv0_ss0 = vec_uu0_rr0_vv0_ss0, 
              vec_uu1_rr1_vv1_ss1 = vec_uu1_rr1_vv1_ss1, 
              vec_V0_V1_S0_S1 = vec_V0_V1_S0_S1, 
              vec_V2_V3_S2_S3 = vec_V2_V3_S2_S3, 
              vec_V4_V5_S4_S5 = vec_V4_V5_S4_S5, 
...
asm_output_path = os.path.join("..", "asm", "inverse_4_generic.s")
