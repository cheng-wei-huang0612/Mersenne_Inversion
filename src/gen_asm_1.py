...
asm_main += f"str {Vlimb64_0}, [{ptr_inv}]\n"
asm_main += f"str {Vlimb64_1}, [{ptr_inv}, #8]\n"
asm_main += f"str {Vlimb64_2}, [{ptr_inv}, #16]\n"
asm_main += f"str {Vlimb64_3}, [{ptr_inv}, #24]\n"
