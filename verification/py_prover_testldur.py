...
gas_path = "gas_files/ldur_test.gas"
raw_cl_path = "ldur_test_raw.cl"
cl_path = "ldur_test.cl"
...
""")
    ...
    # byte_ptr = getandappend_multiple_next_instruction(byte_ptr, emit_blocks, 30)
