...

{
    ...
    x1 = x1_in,
    x2 = x2_in,
    x7 = (umod x1 (const 64 (2**20))) + (const 64 ( - (2**41))),
    x8 = (umod x2 (const 64 (2**20))) + (const 64 ( - (2**62)))
}
...
nondet x7@uint64;
nondet x8@uint64;
call init_fuv_grs(x1, x2, x7, x8; x1, x2, x7, x8);
...
//     (const 64 0) - r_0_20 + s_0_20 <=s (const 64 (2**20)),
//     (const 64 0) - r_0_20 - s_0_20 <=s (const 64 (2**20)),
//     const_2p41a2p20 = (const 64 (2**20 + 2**41)) prove with [cuts [0]]
// ;
//
//
// // extraction
