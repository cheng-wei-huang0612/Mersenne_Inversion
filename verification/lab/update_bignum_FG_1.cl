...
assume and [
    ...
    && 
    [0@sint32, 0@sint32, 0@sint32, 0@sint32] <=s %v3,
    %v3 <=s [((2**30)-1)@sint32, ((2**30)-1)@sint32, ((2**30)-1)@sint32, ((2**30)-1)@sint32]
    ;
...
assert true &&
%v16[0] * (const 64 (2**30)) + %v4[0] = %v16_old4[0],
%v16[1] * (const 64 (2**30)) + %v4[1] = %v16_old4[1],
(const 64 0) <=s %v4[0], %v4[0] <=s (const 64 ((2**30)-1)),
(const 64 0) <=s %v4[1], %v4[1] <=s (const 64 ((2**30)-1))
;

assume 
%v16[0] * (2**30) + %v4[0] = %v16_old4[0],
%v16[1] * (2**30) + %v4[1] = %v16_old4[1],
0 <= %v4[0], %v4[0] <= ((2**30)-1),
0 <= %v4[1], %v4[1] <= ((2**30)-1)
&&
%v16[0] * (const 64 (2**30)) + %v4[0] = %v16_old4[0],
...
assert true &&
(const 32 0) <=s %v4[0], %v4[0] <=s (const 32 ((2**30) -1)),
(const 32 0) <=s %v4[1], %v4[1] <=s (const 32 ((2**30) -1)),
(const 32 0) <=s %v4[2], %v4[2] <=s (const 32 ((2**30) -1)),
(const 32 0) <=s %v4[3], %v4[3] <=s (const 32 ((2**30) -1))
;
...
assert true &&
%v16[0] * (const 64 (2**30)) + %v5[0] = %v16_old6[0],
%v16[1] * (const 64 (2**30)) + %v5[1] = %v16_old6[1],
(const 64 0) <=s %v5[0], %v5[0] <=s (const 64 ((2**30)-1)),
(const 64 0) <=s %v5[1], %v5[1] <=s (const 64 ((2**30)-1))
;

assume 
%v16[0] * (2**30) + %v5[0] = %v16_old6[0],
%v16[1] * (2**30) + %v5[1] = %v16_old6[1],
0 <= %v5[0], %v5[0] <= ((2**30)-1),
0 <= %v5[1], %v5[1] <= ((2**30)-1)
&&
%v16[0] * (const 64 (2**30)) + %v5[0] = %v16_old6[0],
...
cut and [
%v16[0] * (2**210) + %v5[0] * (2**180) + %v4[1] * (2**150) + %v4[0] * (2**120) + %v3[1] * (2**90) + %v3[0] * (2**60)  =
   %vec_uu0_rr0_vv0_ss0[0] * %vec_F0_F1_G0_G1[0] + %vec_uu0_rr0_vv0_ss0[2] * %vec_F0_F1_G0_G1[2] +
   (
       %vec_uu1_rr1_vv1_ss1[0] * %vec_F0_F1_G0_G1[0] + %vec_uu1_rr1_vv1_ss1[2] * %vec_F0_F1_G0_G1[2] +
       %vec_uu0_rr0_vv0_ss0[0] * %vec_F0_F1_G0_G1[1] + %vec_uu0_rr0_vv0_ss0[2] * %vec_F0_F1_G0_G1[3]
...
,
%v16[1] * (2**210) + %v5[1] * (2**180) + %v4[3] * (2**150) + %v4[2] * (2**120) + %v3[3] * (2**90) + %v3[2] * (2**60)  =
   %vec_uu0_rr0_vv0_ss0[1] * %vec_F0_F1_G0_G1[0] + %vec_uu0_rr0_vv0_ss0[3] * %vec_F0_F1_G0_G1[2] +
   (
       %vec_uu1_rr1_vv1_ss1[1] * %vec_F0_F1_G0_G1[0] + %vec_uu1_rr1_vv1_ss1[3] * %vec_F0_F1_G0_G1[2] +
       %vec_uu0_rr0_vv0_ss0[1] * %vec_F0_F1_G0_G1[1] + %vec_uu0_rr0_vv0_ss0[3] * %vec_F0_F1_G0_G1[3]
...
assert true &&
%v16[0] * (const 64 (2**30)) + %v17[0] = %v16_old7[0],
%v16[1] * (const 64 (2**30)) + %v17[1] = %v16_old7[1],
(const 64 0) <=s %v17[0], %v17[0] <=s (const 64 ((2**30)-1)),
(const 64 0) <=s %v17[1], %v17[1] <=s (const 64 ((2**30)-1))
;

assume 
%v16[0] * (2**30) + %v17[0] = %v16_old7[0],
%v16[1] * (2**30) + %v17[1] = %v16_old7[1],
0 <= %v17[0], %v17[0] <= ((2**30)-1),
0 <= %v17[1], %v17[1] <= ((2**30)-1)
&&
%v16[0] * (const 64 (2**30)) + %v17[0] = %v16_old7[0],
...
mov %v5_in %v5;
nondet %v5@sint32[4];
call insert_high(%v5_in, %v17; %v5);

assert 
%v16[0] * (2**30) + %v5[1] = %v16_old7[0]
,
%v16[1] * (2**30) + %v5[3] = %v16_old7[1]
&& true;

assert true &&
(const 32 0) <=s %v5[0], %v5[0] <=s (const 32 ((2**30) -1)),
(const 32 0) <=s %v5[1], %v5[1] <=s (const 32 ((2**30) -1)),
(const 32 0) <=s %v5[2], %v5[2] <=s (const 32 ((2**30) -1)),
(const 32 0) <=s %v5[3], %v5[3] <=s (const 32 ((2**30) -1))
;
...
cut and [
%v16[0] * (2**240) + %v5[1] * (2**210) + %v5[0] * (2**180) + %v4[1] * (2**150) + %v4[0] * (2**120) + %v3[1] * (2**90) + %v3[0] * (2**60)  =
   %vec_uu0_rr0_vv0_ss0[0] * %vec_F0_F1_G0_G1[0] + %vec_uu0_rr0_vv0_ss0[2] * %vec_F0_F1_G0_G1[2] +
   (
       %vec_uu1_rr1_vv1_ss1[0] * %vec_F0_F1_G0_G1[0] + %vec_uu1_rr1_vv1_ss1[2] * %vec_F0_F1_G0_G1[2] +
       %vec_uu0_rr0_vv0_ss0[0] * %vec_F0_F1_G0_G1[1] + %vec_uu0_rr0_vv0_ss0[2] * %vec_F0_F1_G0_G1[3]
...
,
%v16[1] * (2**240) + %v5[3] * (2**210) + %v5[2] * (2**180) + %v4[3] * (2**150) + %v4[2] * (2**120) + %v3[3] * (2**90) + %v3[2] * (2**60)  =
   %vec_uu0_rr0_vv0_ss0[1] * %vec_F0_F1_G0_G1[0] + %vec_uu0_rr0_vv0_ss0[3] * %vec_F0_F1_G0_G1[2] +
   (
       %vec_uu1_rr1_vv1_ss1[1] * %vec_F0_F1_G0_G1[0] + %vec_uu1_rr1_vv1_ss1[3] * %vec_F0_F1_G0_G1[2] +
       %vec_uu0_rr0_vv0_ss0[1] * %vec_F0_F1_G0_G1[1] + %vec_uu0_rr0_vv0_ss0[3] * %vec_F0_F1_G0_G1[3]
...
assert true &&
%v16[0] * (const 64 (2**30)) + %v6[0] = %v16_old8[0],
%v16[1] * (const 64 (2**30)) + %v6[1] = %v16_old8[1],
(const 64 0) <=s %v6[0], %v6[0] <=s (const 64 ((2**30)-1)),
(const 64 0) <=s %v6[1], %v6[1] <=s (const 64 ((2**30)-1))
;

assume 
%v16[0] * (2**30) + %v6[0] = %v16_old8[0],
%v16[1] * (2**30) + %v6[1] = %v16_old8[1],
0 <= %v6[0], %v6[0] <= ((2**30)-1),
0 <= %v6[1], %v6[1] <= ((2**30)-1)
&&
%v16[0] * (const 64 (2**30)) + %v6[0] = %v16_old8[0],
...
cut and [
%v16[0] * (2**270) + %v6[0] * (2**240) + %v5[1] * (2**210) + %v5[0] * (2**180) + %v4[1] * (2**150) + %v4[0] * (2**120) + %v3[1] * (2**90) + %v3[0] * (2**60)  =
   %vec_uu0_rr0_vv0_ss0[0] * %vec_F0_F1_G0_G1[0] + %vec_uu0_rr0_vv0_ss0[2] * %vec_F0_F1_G0_G1[2] +
   (
       %vec_uu1_rr1_vv1_ss1[0] * %vec_F0_F1_G0_G1[0] + %vec_uu1_rr1_vv1_ss1[2] * %vec_F0_F1_G0_G1[2] +
       %vec_uu0_rr0_vv0_ss0[0] * %vec_F0_F1_G0_G1[1] + %vec_uu0_rr0_vv0_ss0[2] * %vec_F0_F1_G0_G1[3]
...
,
%v16[1] * (2**270) + %v6[1] * (2**240) + %v5[3] * (2**210) + %v5[2] * (2**180) + %v4[3] * (2**150) + %v4[2] * (2**120) + %v3[3] * (2**90) + %v3[2] * (2**60)  =
   %vec_uu0_rr0_vv0_ss0[1] * %vec_F0_F1_G0_G1[0] + %vec_uu0_rr0_vv0_ss0[3] * %vec_F0_F1_G0_G1[2] +
   (
       %vec_uu1_rr1_vv1_ss1[1] * %vec_F0_F1_G0_G1[0] + %vec_uu1_rr1_vv1_ss1[3] * %vec_F0_F1_G0_G1[2] +
       %vec_uu0_rr0_vv0_ss0[1] * %vec_F0_F1_G0_G1[1] + %vec_uu0_rr0_vv0_ss0[3] * %vec_F0_F1_G0_G1[3]
...
assert true &&
%v7[0] * (const 64 (2**30)) + %v17[0] = %v16_old9[0],
%v7[1] * (const 64 (2**30)) + %v17[1] = %v16_old9[1],
(const 64 0) <=s %v17[0], %v17[0] <=s (const 64 ((2**30)-1)),
(const 64 0) <=s %v17[1], %v17[1] <=s (const 64 ((2**30)-1))
;

assume 
%v7[0] * (2**30) + %v17[0] = %v16_old9[0],
%v7[1] * (2**30) + %v17[1] = %v16_old9[1],
0 <= %v17[0], %v17[0] <= ((2**30)-1),
0 <= %v17[1], %v17[1] <= ((2**30)-1)
&&
%v7[0] * (const 64 (2**30)) + %v17[0] = %v16_old9[0],
...
mov %v6_in %v6;
nondet %v6@sint32[4];
call insert_high(%v6_in, %v17; %v6);

assert 
%v7[0] * (2**30) + %v6[1] = %v16_old9[0]
,
%v7[1] * (2**30) + %v6[3] = %v16_old9[1]
&& true;

assert true &&
(const 32 0) <=s %v6[0], %v6[0] <=s (const 32 ((2**30) -1)),
(const 32 0) <=s %v6[1], %v6[1] <=s (const 32 ((2**30) -1)),
(const 32 0) <=s %v6[2], %v6[2] <=s (const 32 ((2**30) -1)),
(const 32 0) <=s %v6[3], %v6[3] <=s (const 32 ((2**30) -1))
;
...
call lemma_A(
    ...
    %vec_F0_F1_G0_G1, %vec_F2_F3_G2_G3,
    %vec_F4_F5_G4_G5, %vec_F6_F7_G6_G7,
    %vec_F8_F9_G8_G9,  %vec_2x_2p30m1,
    %vec_F0_F1_G0_G1_expected, %vec_F2_F3_G2_G3_expected,
    %vec_F4_F5_G4_G5_expected, %vec_F6_F7_G6_G7_expected,
    %vec_F8_F9_G8_G9_expected,
    %v7,
    %v6,
    %v5,
    %v4,
...
assert and [
    ...
    %v5 = %vec_F4_F5_G4_G5_expected,
    %v6 = %vec_F6_F7_G6_G7_expected,
    ...
    prove with [algebra solver isl, all cuts, precondition]
    && true;
...
assert and [
    ...
    [0,0,0,0] <= %v5, %v5 <= [((2**30)-1), ((2**30)-1), ((2**30)-1), ((2**30)-1)],
    [0,0,0,0] <= %v6, %v6 <= [((2**30)-1), ((2**30)-1), ((2**30)-1), ((2**30)-1)],
    [(-(2**15)),(-1),(-(2**15)),(-1)] <= %v7, %v7 <= [((2**15)-1), (0), ((2**15)-1), (0)]
...
assume and [
    ...
    mov %vec_F0_F1_G0_G1_out %v3;
    mov %vec_F2_F3_G2_G3_out %v4;
    mov %vec_F4_F5_G4_G5_out %v5;
    mov %vec_F6_F7_G6_G7_out %v6;
    mov %vec_F8_F9_G8_G9_out %v7;
...
%v7[0] * (2**300) + %v6[1] * (2**270) + %v6[0] * (2**240) + %v5[1] * (2**210) + %v5[0] * (2**180) + %v4[1] * (2**150) + %v4[0] * (2**120) + %v3[1] * (2**90) + %v3[0] * (2**60) 
    ...
    ,
%v7[2] * (2**300) + %v6[3] * (2**270) + %v6[2] * (2**240) + %v5[3] * (2**210) + %v5[2] * (2**180) + %v4[3] * (2**150) + %v4[2] * (2**120) + %v3[3] * (2**90) + %v3[2] * (2**60) 
    = 
    limbs 30 [
        %vec_F0_F1_G0_G1_expected[2], %vec_F0_F1_G0_G1_expected[3],
        %vec_F2_F3_G2_G3_expected[2], %vec_F2_F3_G2_G3_expected[3],
...
{and [
    ...
    limbs 30 [
        %vec_F0_F1_G0_G1_out[0], %vec_F0_F1_G0_G1_out[1],
        %vec_F2_F3_G2_G3_out[0], %vec_F2_F3_G2_G3_out[1],
        %vec_F4_F5_G4_G5_out[0], %vec_F4_F5_G4_G5_out[1],
        %vec_F6_F7_G6_G7_out[0], %vec_F6_F7_G6_G7_out[1],
        %vec_F8_F9_G8_G9_out[0]
    ] * ((2**60))
    ,
    // r * F + s * G  
    limbs 30 [
    ...
    limbs 30 [
        %vec_F0_F1_G0_G1_out[2], %vec_F0_F1_G0_G1_out[3],
        %vec_F2_F3_G2_G3_out[2], %vec_F2_F3_G2_G3_out[3],
        %vec_F4_F5_G4_G5_out[2], %vec_F4_F5_G4_G5_out[3],
        %vec_F6_F7_G6_G7_out[2], %vec_F6_F7_G6_G7_out[3],
        %vec_F8_F9_G8_G9_out[2]
        // , %vec_F8_F9_G8_G9_expected[3]
    ] * ((2**60))
    ,
    [0,0,0,0] <= %vec_F0_F1_G0_G1_out, %vec_F0_F1_G0_G1_out <= [((2**30)-1), ((2**30)-1), ((2**30)-1), ((2**30)-1)],
    [0,0,0,0] <= %vec_F2_F3_G2_G3_out, %vec_F2_F3_G2_G3_out <= [((2**30)-1), ((2**30)-1), ((2**30)-1), ((2**30)-1)],
    [0,0,0,0] <= %vec_F4_F5_G4_G5_out, %vec_F4_F5_G4_G5_out <= [((2**30)-1), ((2**30)-1), ((2**30)-1), ((2**30)-1)],
    [0,0,0,0] <= %vec_F6_F7_G6_G7_out, %vec_F6_F7_G6_G7_out <= [((2**30)-1), ((2**30)-1), ((2**30)-1), ((2**30)-1)],
    [(-(2**15)),(-1),(-(2**15)),(-1)] <= %vec_F8_F9_G8_G9_out, %vec_F8_F9_G8_G9_out <= [((2**15)-1), (0), ((2**15)-1), (0)]
]
// prove with []
&& 
true prove with [all cuts, precondition]}
