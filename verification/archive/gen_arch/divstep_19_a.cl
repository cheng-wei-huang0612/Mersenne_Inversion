proc divstep_19_a(sint64 fuv_in, sint64 grs_in, sint64 delta_in,
...
0 (mod (2**18)),
u_in * f_0_low60_0_low20_ref0 + v_in * g_0_low60_0_low20_ref0 = 
(-1) * (2**18) * f_0_low60_0_low20_in (mod (2**64))
,
r_in * f_0_low60_0_low20_ref0 + s_in * g_0_low60_0_low20_ref0 = 
(-1) * (2**18) * g_0_low60_0_low20_in (mod (2**64))
&& 
(const 21 (-(2**18))) <=s u_in, u_in <=s (const 21 ((2**18)-1)),
(const 21 (-(2**18))) <=s v_in, v_in <=s (const 21 ((2**18)-1)),
(const 21 (-(2**18))) <=s r_in, r_in <=s (const 21 ((2**18)-1)),
(const 21 (-(2**18))) <=s s_in, s_in <=s (const 21 ((2**18)-1)),

(const 21 (-(2**19))) <s (v_in + s_in),
...
(sext u_in 43) * (const 64 (2**(21+2))) +
(sext v_in 43) * (const 64 (2**(42+2)))
,
grs_in = 
	 (sext g_0_low60_0_low20_in 42) +
(sext r_in 43) * (const 64 (2**(21+2))) +
(sext s_in 43) * (const 64 (2**(42+2)))
}
...
(sext u_out 43) * (const 64 (2**(21+1))) +
(sext v_out 43) * (const 64 (2**(42+1)));
assert true && 
grs_out = 
(sext g_0_low60_0_low20_out 42) +
(sext r_out 43) * (const 64 (2**(21+1))) +
(sext s_out 43) * (const 64 (2**(42+1)));
...
u_out * f_0_low60_0_low20_ref0 +
v_out * g_0_low60_0_low20_ref0 =
(-1) * ((2**19)) * f_0_low60_0_low20_out (mod (2**64))
,
r_out * f_0_low60_0_low20_ref0 +
s_out * g_0_low60_0_low20_ref0 =
(-1) * ((2**19)) * g_0_low60_0_low20_out (mod (2**64))
&&
(* premise a assertion*)
f_0_low60_0_low20_out = f_0_low60_0_low20_in,
g_0_low60_0_low20_out * (const 22 2) = g_0_low60_0_low20_in,
...
(* common Assertion *)
(const 21 (-(2**19))) <=s u_out, u_out <=s (const 21 ((2**19)-1)),
(const 21 (-(2**19))) <=s v_out, v_out <=s (const 21 ((2**19)-1)),
(const 21 (-(2**19))) <=s r_out, r_out <=s (const 21 ((2**19)-1)),
(const 21 (-(2**19))) <=s s_out, s_out <=s (const 21 ((2**19)-1)),

(const 21 (-(2**20))) <s (v_out + s_out),
