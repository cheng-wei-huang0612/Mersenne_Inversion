proc divstep_11_a(sint64 fuv_in, sint64 grs_in, sint64 delta_in,
...
0 (mod (2**10)),
u_in * f_0_low60_0_low20_ref0 + v_in * g_0_low60_0_low20_ref0 = 
(-1) * (2**10) * f_0_low60_0_low20_in (mod (2**64))
,
r_in * f_0_low60_0_low20_ref0 + s_in * g_0_low60_0_low20_ref0 = 
(-1) * (2**10) * g_0_low60_0_low20_in (mod (2**64))
&& 
(const 21 (-(2**10))) <=s u_in, u_in <=s (const 21 ((2**10)-1)),
(const 21 (-(2**10))) <=s v_in, v_in <=s (const 21 ((2**10)-1)),
(const 21 (-(2**10))) <=s r_in, r_in <=s (const 21 ((2**10)-1)),
(const 21 (-(2**10))) <=s s_in, s_in <=s (const 21 ((2**10)-1)),

(const 21 (-(2**11))) <s (v_in + s_in),
...
(sext u_in 43) * (const 64 (2**(21+10))) +
(sext v_in 43) * (const 64 (2**(42+10)))
,
grs_in = 
	 (sext g_0_low60_0_low20_in 42) +
(sext r_in 43) * (const 64 (2**(21+10))) +
(sext s_in 43) * (const 64 (2**(42+10)))
}
...
(* premise for case a*)
assume true && g_0_low60_0_low20_in = (const 22 0) (mod (const 22 2));
assert true && x8 = (const 64 0) (mod (const 64 2));
(* premise for case a*)
...
(* According to premise of case a *)
assert true && x7 = x7_old;
assert true && x8 * (const 64 2) = x8_old;
...
asr g_0_low60_0_low20_out g_0_low60_0_low20_in 1;
...
assert
true &&
g_0_low60_0_low20_out * (const 22 2) = g_0_low60_0_low20_in;
assume
g_0_low60_0_low20_out * 2 = g_0_low60_0_low20_in
&& true;
...
(sext u_out 43) * (const 64 (2**(21+9))) +
(sext v_out 43) * (const 64 (2**(42+9)));
assert true && 
grs_out = 
(sext g_0_low60_0_low20_out 42) +
(sext r_out 43) * (const 64 (2**(21+9))) +
(sext s_out 43) * (const 64 (2**(42+9)));
...
u_out * f_0_low60_0_low20_ref0 +
v_out * g_0_low60_0_low20_ref0 =
(-1) * ((2**11)) * f_0_low60_0_low20_out (mod (2**64))
,
r_out * f_0_low60_0_low20_ref0 +
s_out * g_0_low60_0_low20_ref0 =
(-1) * ((2**11)) * g_0_low60_0_low20_out (mod (2**64))
&&
(* premise a assertion*)
f_0_low60_0_low20_out = f_0_low60_0_low20_in,
g_0_low60_0_low20_out * (const 22 2) = g_0_low60_0_low20_in,
...
(* common Assertion *)
(const 21 (-(2**11))) <=s u_out, u_out <=s (const 21 ((2**11)-1)),
(const 21 (-(2**11))) <=s v_out, v_out <=s (const 21 ((2**11)-1)),
(const 21 (-(2**11))) <=s r_out, r_out <=s (const 21 ((2**11)-1)),
(const 21 (-(2**11))) <=s s_out, s_out <=s (const 21 ((2**11)-1)),

(const 21 (-(2**12))) <s (v_out + s_out),
