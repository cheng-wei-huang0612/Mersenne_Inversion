proc divstep_13_a(sint64 fuv_in, sint64 grs_in, sint64 delta_in,
...
0 (mod (2**12)),
u_in * f_0_low60_0_low20_ref0 + v_in * g_0_low60_0_low20_ref0 = 
(-1) * (2**12) * f_0_low60_0_low20_in (mod (2**64))
,
r_in * f_0_low60_0_low20_ref0 + s_in * g_0_low60_0_low20_ref0 = 
(-1) * (2**12) * g_0_low60_0_low20_in (mod (2**64))
&& 
(const 21 (-(2**12))) <=s u_in, u_in <=s (const 21 ((2**12)-1)),
(const 21 (-(2**12))) <=s v_in, v_in <=s (const 21 ((2**12)-1)),
(const 21 (-(2**12))) <=s r_in, r_in <=s (const 21 ((2**12)-1)),
(const 21 (-(2**12))) <=s s_in, s_in <=s (const 21 ((2**12)-1)),

(const 21 (-(2**13))) <s (v_in + s_in),
...
(sext u_in 43) * (const 64 (2**(21+8))) +
(sext v_in 43) * (const 64 (2**(42+8)))
,
grs_in = 
	 (sext g_0_low60_0_low20_in 42) +
(sext r_in 43) * (const 64 (2**(21+8))) +
(sext s_in 43) * (const 64 (2**(42+8)))
}
...
(sext u_out 43) * (const 64 (2**(21+7))) +
(sext v_out 43) * (const 64 (2**(42+7)));
assert true && 
grs_out = 
(sext g_0_low60_0_low20_out 42) +
(sext r_out 43) * (const 64 (2**(21+7))) +
(sext s_out 43) * (const 64 (2**(42+7)));
...
u_out * f_0_low60_0_low20_ref0 +
v_out * g_0_low60_0_low20_ref0 =
(-1) * ((2**13)) * f_0_low60_0_low20_out (mod (2**64))
,
r_out * f_0_low60_0_low20_ref0 +
s_out * g_0_low60_0_low20_ref0 =
(-1) * ((2**13)) * g_0_low60_0_low20_out (mod (2**64))
&&
(* premise a assertion*)
f_0_low60_0_low20_out = f_0_low60_0_low20_in,
g_0_low60_0_low20_out * (const 22 2) = g_0_low60_0_low20_in,
...
(* common Assertion *)
(const 21 (-(2**13))) <=s u_out, u_out <=s (const 21 ((2**13)-1)),
(const 21 (-(2**13))) <=s v_out, v_out <=s (const 21 ((2**13)-1)),
(const 21 (-(2**13))) <=s r_out, r_out <=s (const 21 ((2**13)-1)),
(const 21 (-(2**13))) <=s s_out, s_out <=s (const 21 ((2**13)-1)),

(const 21 (-(2**14))) <s (v_out + s_out),
