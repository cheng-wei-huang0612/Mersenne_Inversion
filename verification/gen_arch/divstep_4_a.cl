proc divstep_4_a(sint64 fuv_in, sint64 grs_in, sint64 delta_in,
...
0 (mod (2**3)),
u_in * f_0_low60_0_low20_ref0 + v_in * g_0_low60_0_low20_ref0 = 
(-1) * (2**3) * f_0_low60_0_low20_in (mod (2**64))
,
r_in * f_0_low60_0_low20_ref0 + s_in * g_0_low60_0_low20_ref0 = 
(-1) * (2**3) * g_0_low60_0_low20_in (mod (2**64))
&& 
(const 21 (-(2**3))) <=s u_in, u_in <=s (const 21 ((2**3)-1)),
(const 21 (-(2**3))) <=s v_in, v_in <=s (const 21 ((2**3)-1)),
(const 21 (-(2**3))) <=s r_in, r_in <=s (const 21 ((2**3)-1)),
(const 21 (-(2**3))) <=s s_in, s_in <=s (const 21 ((2**3)-1)),

(const 21 (-(2**4))) <s (v_in + s_in),
...
(sext u_in 43) * (const 64 (2**(21+17))) +
(sext v_in 43) * (const 64 (2**(42+17)))
,
grs_in = 
	 (sext g_0_low60_0_low20_in 42) +
(sext r_in 43) * (const 64 (2**(21+17))) +
(sext s_in 43) * (const 64 (2**(42+17)))
}
...
(sext u_out 43) * (const 64 (2**(21+16))) +
(sext v_out 43) * (const 64 (2**(42+16)));
assert true && 
grs_out = 
(sext g_0_low60_0_low20_out 42) +
(sext r_out 43) * (const 64 (2**(21+16))) +
(sext s_out 43) * (const 64 (2**(42+16)));
...
u_out * f_0_low60_0_low20_ref0 +
v_out * g_0_low60_0_low20_ref0 =
(-1) * ((2**4)) * f_0_low60_0_low20_out (mod (2**64))
,
r_out * f_0_low60_0_low20_ref0 +
s_out * g_0_low60_0_low20_ref0 =
(-1) * ((2**4)) * g_0_low60_0_low20_out (mod (2**64))
&&
(* premise a assertion*)
f_0_low60_0_low20_out = f_0_low60_0_low20_in,
g_0_low60_0_low20_out * (const 22 2) = g_0_low60_0_low20_in,
...
(* common Assertion *)
(const 21 (-(2**4))) <=s u_out, u_out <=s (const 21 ((2**4)-1)),
(const 21 (-(2**4))) <=s v_out, v_out <=s (const 21 ((2**4)-1)),
(const 21 (-(2**4))) <=s r_out, r_out <=s (const 21 ((2**4)-1)),
(const 21 (-(2**4))) <=s s_out, s_out <=s (const 21 ((2**4)-1)),

(const 21 (-(2**5))) <s (v_out + s_out),
