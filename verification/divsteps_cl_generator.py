...
def divstep_gen(i, j, k, case, you_shall_not_pass = False):
    ...
    if i == 0:
        ...
        f"(const 64 (-(2**20))) <=s u_{59*k + 20*j}_{59*k + 20*j + i}, u_{59*k + 20*j}_{59*k + 20*j + i} <=s (const 64 ((2**20)-1))",
        f"(const 64 (-(2**20))) <=s v_{59*k + 20*j}_{59*k + 20*j + i}, v_{59*k + 20*j}_{59*k + 20*j + i} <=s (const 64 ((2**20)-1))",
        f"(const 64 (-(2**20))) <=s r_{59*k + 20*j}_{59*k + 20*j + i}, r_{59*k + 20*j}_{59*k + 20*j + i} <=s (const 64 ((2**20)-1))",
        f"(const 64 (-(2**20))) <=s s_{59*k + 20*j}_{59*k + 20*j + i}, s_{59*k + 20*j}_{59*k + 20*j + i} <=s (const 64 ((2**20)-1))",
